...
export default function Hero() {
  ...
  return (
    <>
      {/* FIXED SPACING — no more huge gap after hero */}
      ...
      <div className="max-w-[1200px] mx-auto w-full">
          ...
          <AnimatedGradient>
            ...
            >
              ...
              <motion.div
                variants={item}
                className="text-[var(--color-accent-dark)] text-xl sm:text-2xl md:text-3xl font-medium h-9 flex items-center justify-center"
              >
